    ...
    <>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  <h3 className="font-bold text-[#cc9900] mb-2">Community Trust</h3>
                  <ul className="text-sm text-gray-600 space-y-2">
      ...
      <section className="bg-[#22263c] text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-center mt-4 mb-8">Market Positioning Framework: Single/Dual Use & Monitor/Control Paradigm</p>
          <p className="text-center mt-4 mb-12 max-w-3xl mx-auto">We have performed a comprehensive competitive analysis and identified relevant companies across this framework, evaluating their capabilities in misinformation detection and content control across single-use tools and dual-use platforms that serve both civilian and defense applications.</p>
          <div className="relative h-96 mt-12">
            ...
            {/* Axis labels */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -mt-8 text-lg font-bold text-[#4e989e]">Single Use</div>
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 -mb-8 text-lg font-bold text-[#e86530]">Dual Use</div>
            <div className="absolute top-1/2 left-0 -translate-y-1/2 -ml-24 text-lg font-bold text-[#94d2bd]">Monitor</div>
            <div className="absolute top-1/2 right-0 -translate-y-1/2 -mr-24 text-lg font-bold text-[#cc9900]">Control</div>
            
            {/* Quadrant descriptions */}
            <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-44 text-center">
              <p className="text-sm bg-[#94d2bd]/20 text-white rounded-full px-3 py-2 border border-[#94d2bd]/30">Tools that passively track misinformation</p>
            </div>
            <div className="absolute top-1/4 right-1/4 translate-x-16 -translate-y-1/2 w-44 text-center">
              <p className="text-sm bg-[#cc9900]/20 text-white rounded-full px-3 py-2 border border-[#cc9900]/30">Solutions that actively manage content integrity</p>
            </div>
            <div className="absolute bottom-1/4 left-1/4 -translate-x-1/2 translate-y-8 w-44 text-center">
              <p className="text-sm bg-[#4e989e]/20 text-white rounded-full px-3 py-2 border border-[#4e989e]/30">Platforms serving both private and public sectors</p>
            </div>
            <div className="absolute bottom-1/4 right-1/4 translate-x-16 translate-y-8 w-44 text-center">
              <p className="text-sm bg-[#e86530]/20 text-white rounded-full px-3 py-2 border border-[#e86530]/30">Full-spectrum solutions for multiple use cases</p>
            </div>
          </div>
        </div>
      </section>
